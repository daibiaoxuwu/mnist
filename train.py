...
initial_training_rate=0.01     #学习率
training_iters = 10000000       #迭代次数
batch_size=50                   #batch数量
display_step = 200               #多少步输出一次结果
...
reader = importlib.import_module('mnistreader')
rnnmodel = importlib.import_module('mnistcnnmodel')
...
#输出
                    if step % display_step == 0:
                        ...
                        if False:# testflag==False and acc_total>max_acc_total:
